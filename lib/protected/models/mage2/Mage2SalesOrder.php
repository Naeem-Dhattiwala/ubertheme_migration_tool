 ...
 */
class Mage2SalesOrder extends Mage2ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('state, status, increment_id, customer_prefix, customer_suffix, customer_taxvat, ext_customer_id, ext_order_id, hold_before_state, hold_before_status, original_increment_id, relation_child_id, relation_child_real_id, relation_parent_id, relation_parent_real_id, store_name, x_forwarded_for', 'length', 'max'=>32),
			...
			array('remote_ip', 'length', 'max'=>45),
			array('shipping_method', 'length', 'max'=>120),
	 ...
	 * @return Mage2SalesOrder the static model class
	 */
