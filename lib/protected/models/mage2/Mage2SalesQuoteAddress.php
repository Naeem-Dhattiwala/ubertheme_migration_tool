 ...
 */
class Mage2SalesQuoteAddress extends Mage2ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('firstname, lastname, email, company, street, city, region, telephone, fax, shipping_description, discount_description', 'length', 'max'=>255),
			array('middlename, prefix, suffix', 'length', 'max'=>40),
			array('shipping_method', 'length', 'max'=>120), //this rule applied from Magento ver.2.2.0
	 ...
	 * @return Mage2SalesQuoteAddress the static model class
	 */
