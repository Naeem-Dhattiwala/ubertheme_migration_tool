 ...
 */
class Mage2SalesOrderPayment extends Mage2ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('echeck_bank_name, method, cc_ss_start_month, cc_owner, cc_number_enc', 'length', 'max'=>128),
			array('cc_debug_request_body, cc_secure_verify, protection_eligibility, cc_approval, cc_status_description, echeck_type, cc_debug_response_serialized, last_trans_id, cc_cid_status, cc_type, po_number, echeck_routing_number, account_status, anet_trans_method, cc_debug_response_body, cc_ss_issue, echeck_account_name, cc_avs_status, cc_trans_id, address_status', 'length', 'max'=>32),
	 ...
	 * @return Mage2SalesOrderPayment the static model class
	 */
